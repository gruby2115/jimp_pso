...
// Pomocnicza: losowa liczba z zakresu [0, 1]
double random_01() {
    return (double)rand() / (double)RAND_MAX;
}

// Pomocnicza: losowa pozycja na mapie
...
Swarm* init_swarm(int count, Map* mapa) {
    ...
    for (int i = 0; i < count; i++) {
        ...
        // Na pocz¹tku pBest to aktualna pozycja
